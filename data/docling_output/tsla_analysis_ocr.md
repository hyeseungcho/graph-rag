...
Emerging	growth	company o Accelerated	filer Smaller	reporting	company
...
ES ABLE	SHARES	OF	THE	COMMON	STOCK	OF	Tesla,	Inc.	(hereinafter	cal ed	the	'Company'),	transferable	on	the	bo ks	of	the	Company	in	person	or	by	duly	authorized	at orney,	upon	sur ender	of	this	Certif cate	properly	endorsed.	This	Certif cate	and	the	shares	represented	hereby,	are	is ued	and	shal 	be	held	subject	 o	al 	of	the	provis ons	of	the	Certif cate	of	Formation	and	the	Bylaws	of	the	Company	(copies	of	which	are	on	file	with	the	Company	and	with	the	Transfer	Agent),	to	al 	of	which	each	holder,	by	ac eptance	hereof,	as ents.	This	Certif cate	is	not	valid	unles 	countersigned	and	registered	by	the	Transfer	Agent	and	Registrar.	Witnes 	the	facsimile	seal	of	the	Company	and	the	facsimile	signatures	of	its	duly	authorized	of icers.	COMMON	STOCK	PAR	VALUE	$0.0
...
THE COMPANY WILL FURNISH WITHOUT CHARGE TO EACH STOCKHOLDER WHO SO REQUESTS, A SUMMARY OF THE POWERS, DESIGNATIONS, PREFERENCES AND RELATIVE, PARTICIPATING, OPTIONAL OR OTHER SPECIAL RIGHTS OF EACH CLASS OF STOCK OF THE COMPANY AND THE QUALIFICATIONS, LIMITATIONS OR RESTRICTIONS OF SUCH PREFERENCES AND RIGHTS, AND THE VARIATIONS IN RIGHTS, PREFERENCES AND LIMITATIONS DETERMINED FOR EACH SERIES, WHICH ARE FIXED BY THE CERTIFICATE OF INCORPORATION OF THE COMPANY, AS AMENDED, AND THO O DD O D  O   D   O D O DI  O DI NE VARIATIONS FOR FUTURE SERIES. SUCH REQUEST MAY BE MADE TO THE OFFICE OF THE SECRETARY OF THE COMPANY OR TO THE TRANSFER AGENT. THE BOARD OF DIRECTORS MAY REQUIRE THE OWNER OF A LOST OR DESTROYED STOCK CERTIFICATE, OR HIS LEGAL RE   T       T   G    II IAT MAY BE MADE AGAINST THEM ON ACCOUNT OF THE ALLEGED LOSS OR DESTRUCTION OF ANY SUCH CERTIFICATE.
...
ost	basi 	calculation	method,	then	we	have	proces ed	as	you	requested.	If	you	did	not	specify	a	cost	basi 	calculation	method,	then	we	have	defaulted	to	the	first	in,	first	out	(FIFO)	method.	Please	consult	your	tax	advisor	if	you	ne d	ad it onal	information	about	cost	basi

.	If	you	do	not	ke p	in	contact	with	the	is uer	or	do	not	have	any	activity	in	your	ac ount	for	the	time	period	specif ed	by	state	law,	your	property	may	become	subject	 o	state	unclaimed	property	laws	and	transfer ed	to	the	ap

oint	 o	transfer	the	said	stock	on	the	bo ks	of	the	within-named	Company	with	ful 	power	of	substi ution	in	the	premises.	 Tesla,	Inc.	THE	COMPANY	WIL 	FURNISH	WITHOUT	CHARGE	TO	EACH	STOCKHOLDER	WHO	SO	REQUESTS,	A	SUMMARY	OF	THE	POWERS,	DESIGNATIONS,	PREFERENCES	AND	RELATIVE,	PARTICIPATING,	OPTIONAL	OR	OTHER	SPECIAL	RIGHTS	OF	EACH	CLAS
...
.	(Minor)	(State)	Ad it onal	ab reviations	may	also	be	used	though	not	in	the	above	list.
...
|                                                                      | Texas          |
| Tesla US Property Holdings, LLC Tesla Wholesale Energy Holdings, LLC | Delaware       |
